...
public class CJDKPSPublicSoap
{
    ...
    public CJDKPSPublicSoap(){}

    public CJDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CJDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CJDExtendedSoapSerializationEnvelope envelope= new CJDExtendedSoapSerializationEnvelope(CJDExtendedSoapSerializationEnvelope.VER11);
